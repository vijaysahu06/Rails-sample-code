class EventsController < ApplicationController
	...
	def create
		...
		if @event.save!
			redirect_to shivir_details_event_path(@event.id), notice: 'Event was successfully created.'
		else
			render :new
		end
	end
